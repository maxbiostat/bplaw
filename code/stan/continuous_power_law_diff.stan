functions{
    real diff_function_lconstant(real alpha, real z, real w, real m);
...
transformed parameters{
  ...
  -phi[1] + diff_function_lconstant(alpha, exp(-phi[2]), exp(-phi[3]), x_min) );
}
model{
